    ...
    <Layout>
      ...
      <div className="m-5 sm:grid sm:grid-cols-2 sm:gap-4 md:grid-cols-3 lg:mx-32">
        ...
        <div className="p-3 pt-5 sm:pt-0 md:col-span-2">
          ...
          <Paragraph>
            Micah is determined to hate everyone and everything in this tiny
            town, until he meets Navy Monroe, his talented, shy, and intelligent
            ...
            talented, shy, and intelligent chemistry lab partner. But Navy
            doesn’t seem to care about his celebrity status, and something about
            her draws Micah in and has him falling fast for her.
          </Paragraph>
          <Paragraph>
            Thrown together in a small town and unlikely circumstances, Micah
            breaks down Navy’s walls and finds someone more beautiful, honest
            and intriguing than any girl he’s ever met. With a budding film
            career on the line, is falling for Navy too risky, or will he chase
            the love story that could change his life forever?
          </Paragraph>
          <Paragraph>
